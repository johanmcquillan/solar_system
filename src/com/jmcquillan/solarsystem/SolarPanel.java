...
public class SolarPanel extends JPanel implements ActionListener {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (CelestialBody C : Celestials) {
            ...
            if (names) g2.drawString(C.getName(), x+5, y-5);
            if (details) {
            ...
            if (radii && C.getClass() == CelestialPlanet.class) g2.drawLine(0, 0, x, y);
        }
        // Draw and label Sun
        g2.setColor(Color.YELLOW);
        g2.fill(Sun);
        g2.setFont(new Font("Monospaced",Font.BOLD,20));
        if (names) g2.drawString("Sol", 10, -10);
    }
